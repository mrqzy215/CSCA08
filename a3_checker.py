...
A simple checker for functions in arxiv_functions.py.
...
class CheckTest(unittest.TestCase):
    ...
    def _check_list_of_names(self, func: callable, args: list) -> None:
        ...
        msg = (f'{func.__name__} should return a list of tuples of two strs:\n'
    ...
    def _check_constants(self, name2value: dict[str, Any], mod: Any) -> None:
        ...
        for name, expected in name2value.items():
            ...
            msg = f'The value of {name} should be {expected} but is {actual}.'
...
checker.run_pyta(MODULENAME + '.py', PYTA_LOCATION,  PYTA_CONFIG,
                 False)
